    ...
    <div className="space-y-4">
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-2 pl-10 rounded-lg bg-codelaunch-elements-background-depth-2 border border-codelaunch-elements-borderColor text-codelaunch-elements-textPrimary placeholder-codelaunch-elements-textTertiary focus:outline-none focus:ring-1 focus:ring-codelaunch-elements-borderColorActive"
        />
        <div className="absolute left-3 top-1/2 -translate-y-1/2">
          {isSearching ? (
            <div className="i-ph:spinner animate-spin w-4 h-4 text-codelaunch-elements-textSecondary" />
          ) : (
            <div className="i-ph:magnifying-glass w-4 h-4 text-codelaunch-elements-textSecondary" />
          )}
        </div>
      </div>
      ...
      <div className="space-y-4">
        {filteredRepositories.length === 0 ? (
          ...
          <>
            ...
            {/* Pagination Controls */}
            {totalPages > 1 && (
              <div className="flex items-center justify-between pt-4 border-t border-codelaunch-elements-borderColor">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-codelaunch-elements-textSecondary px-3">
