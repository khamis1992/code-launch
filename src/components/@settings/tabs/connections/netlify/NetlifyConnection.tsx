...
export default function NetlifyConnection() {
      ...
      <div className="mt-6">
        <Collapsible open={isStatsOpen} onOpenChange={setIsStatsOpen}>
          <CollapsibleTrigger asChild>
            <div className="flex items-center justify-between p-4 rounded-lg bg-codelaunch-elements-background dark:bg-codelaunch-elements-background-depth-2 border border-codelaunch-elements-borderColor dark:border-codelaunch-elements-borderColor hover:border-codelaunch-elements-borderColorActive/70 dark:hover:border-codelaunch-elements-borderColorActive/70 transition-all duration-200">
              <div className="flex items-center gap-2">
                <div className="i-ph:chart-bar w-4 h-4 text-codelaunch-elements-item-contentAccent dark:text-codelaunch-elements-item-contentAccent" />
                <span className="text-sm font-medium text-codelaunch-elements-textPrimary dark:text-codelaunch-elements-textPrimary">
                  Netlify Stats
                </span>
              </div>
              <div
          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="space-y-4 mt-4">
              <div className="flex flex-wrap items-center gap-4">
                <Badge
                  variant="outline"
                  className="flex items-center gap-1 text-codelaunch-elements-textPrimary dark:text-codelaunch-elements-textPrimary"
                >
                  <BuildingLibraryIcon className="h-4 w-4 text-codelaunch-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-codelaunch-elements-textPrimary dark:text-codelaunch-elements-textPrimary"
                >
                  <RocketLaunchIcon className="h-4 w-4 text-codelaunch-elements-item-contentAccent" />
                ...
                {lastUpdated && (
                  <Badge
                    ...
                    className="flex items-center gap-1 text-codelaunch-elements-textPrimary dark:text-codelaunch-elements-textPrimary"
                  >
                    <ClockIcon className="h-4 w-4 text-codelaunch-elements-item-contentAccent" />
              ...
              {sites.length > 0 && (
                <div className="mt-4 space-y-4">
                  <div className="bg-codelaunch-elements-background dark:bg-codelaunch-elements-background-depth-1 border border-codelaunch-elements-borderColor dark:border-codelaunch-elements-borderColor rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-sm font-medium flex items-center gap-2 text-codelaunch-elements-textPrimary dark:text-codelaunch-elements-textPrimary">
                        <BuildingLibraryIcon className="h-4 w-4 text-codelaunch-elements-item-contentAccent dark:text-codelaunch-elements-item-contentAccent" />
                        Your Sites
                      </h4>
                      <Button
                        variant="outline"
                        ...
                        className="flex items-center gap-2 text-codelaunch-elements-textPrimary dark:text-codelaunch-elements-textPrimary hover:bg-codelaunch-elements-item-backgroundActive/10"
                      >
                        <ArrowPathIcon
                          className={classNames(
                            'h-4 w-4 text-codelaunch-elements-item-contentAccent dark:text-codelaunch-elements-item-contentAccent',
                    ...
                    <div className="space-y-3">
                      {sites.map((site, index) => (
                        <div
                          key={site.id}
                          className={classNames(
                            'bg-codelaunch-elements-background dark:bg-codelaunch-elements-background-depth-1 border rounded-lg p-4 transition-all',
                            activeSiteIndex === index
                              ? 'border-codelaunch-elements-item-contentAccent bg-codelaunch-elements-item-backgroundActive/10'
                              : 'border-codelaunch-elements-borderColor hover:border-codelaunch-elements-borderColorActive/70',
                          )}
                          onClick={() => {
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <CloudIcon className="h-5 w-5 text-codelaunch-elements-item-contentAccent dark:text-codelaunch-elements-item-contentAccent" />
                              <span className="font-medium text-codelaunch-elements-textPrimary dark:text-codelaunch-elements-textPrimary">
                                {site.name}
                              </span>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              >
                                ...
                                <span className="text-codelaunch-elements-textPrimary dark:text-codelaunch-elements-textPrimary">
                          ...
                          <div className="mt-3 flex items-center gap-2">
                            <a
                              ...
                              className="text-sm flex items-center gap-1 transition-colors text-codelaunch-elements-link-text hover:text-codelaunch-elements-link-textHover dark:text-white dark:hover:text-codelaunch-elements-link-textHover"
                              onClick={(e) => e.stopPropagation()}
                            >
                              <CloudIcon className="h-3 w-3 text-codelaunch-elements-item-contentAccent dark:text-codelaunch-elements-item-contentAccent" />
                          ...
                          {activeSiteIndex === index && (
                            <>
                              <div className="mt-4 pt-3 border-t border-codelaunch-elements-borderColor">
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    <Button
                                      ...
                                      className="flex items-center gap-1 text-codelaunch-elements-textPrimary dark:text-codelaunch-elements-textPrimary"
                                    >
                                      <action.icon className="h-4 w-4 text-codelaunch-elements-item-contentAccent dark:text-codelaunch-elements-item-contentAccent" />
                                      {action.name}
                                    </Button>
                                  ))}
                                </div>
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <ClockIcon className="h-4 w-4 text-codelaunch-elements-item-contentAccent dark:text-codelaunch-elements-item-contentAccent" />
                                    <span className="text-codelaunch-elements-textSecondary dark:text-codelaunch-elements-textSecondary">
                                      Published {formatDistanceToNow(new Date(site.published_deploy.published_at))} ago
                                    </span>
                                  </div>
                                  {site.published_deploy.branch && (
                                    <div className="flex items-center gap-1 mt-1">
                                      <CodeBracketIcon className="h-4 w-4 text-codelaunch-elements-item-contentAccent dark:text-codelaunch-elements-item-contentAccent" />
                                      <span className="text-codelaunch-elements-textSecondary dark:text-codelaunch-elements-textSecondary">
                    ...
                    <div className="bg-codelaunch-elements-background dark:bg-codelaunch-elements-background-depth-1 border border-codelaunch-elements-borderColor dark:border-codelaunch-elements-borderColor rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        {deploys.map((deploy) => (
                          <div
                            key={deploy.id}
                            className="bg-codelaunch-elements-background dark:bg-codelaunch-elements-background-depth-1 border border-codelaunch-elements-borderColor dark:border-codelaunch-elements-borderColor rounded-lg p-3"
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Badge
                              ...
                              <span className="text-xs text-codelaunch-elements-textSecondary dark:text-codelaunch-elements-textSecondary">
                                {formatDistanceToNow(new Date(deploy.created_at))} ago
                              </span>
                            </div>
                            {deploy.branch && (
                              <div className="mt-2 text-xs text-codelaunch-elements-textSecondary dark:text-codelaunch-elements-textSecondary flex items-center gap-1">
                                <CodeBracketIcon className="h-3 w-3 text-codelaunch-elements-item-contentAccent dark:text-codelaunch-elements-item-contentAccent" />
                                <span className="text-codelaunch-elements-textSecondary dark:text-codelaunch-elements-textSecondary">
                            ...
                            {deploy.deploy_url && (
                              <div className="mt-2 text-xs">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center gap-1 transition-colors text-codelaunch-elements-link-text hover:text-codelaunch-elements-link-textHover dark:text-white dark:hover:text-codelaunch-elements-link-textHover"
                                  onClick={(e) => e.stopPropagation()}
                                >
                                  <CloudIcon className="h-3 w-3 text-codelaunch-elements-item-contentAccent dark:text-codelaunch-elements-item-contentAccent" />
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-codelaunch-elements-textPrimary dark:text-codelaunch-elements-textPrimary"
                                >
                                  <LockClosedIcon className="h-4 w-4 text-codelaunch-elements-item-contentAccent dark:text-codelaunch-elements-item-contentAccent" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-codelaunch-elements-textPrimary dark:text-codelaunch-elements-textPrimary"
                                >
                                  <LockOpenIcon className="h-4 w-4 text-codelaunch-elements-item-contentAccent dark:text-codelaunch-elements-item-contentAccent" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                      ...
                      <div className="space-y-2">
                        {builds.map((build) => (
                          ...
                          >
                            ...
                            {build.error && (
                              <div className="mt-2 text-xs text-codelaunch-elements-textDestructive dark:text-codelaunch-elements-textDestructive flex items-center gap-1">
                                <XCircleIcon className="h-3 w-3 text-codelaunch-elements-textDestructive dark:text-codelaunch-elements-textDestructive" />
                                Error: {build.error}
                              </div>
                            )}
                          </div>
  ...
  return (
    <div className="space-y-6 bg-codelaunch-elements-background dark:bg-codelaunch-elements-background border border-codelaunch-elements-borderColor dark:border-codelaunch-elements-borderColor rounded-lg">
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium text-codelaunch-elements-textPrimary">Netlify Connection</h2>
          </div>
        </div>

        {!connection.user ? (
          <div className="mt-4">
            <label className="block text-sm text-codelaunch-elements-textSecondary dark:text-codelaunch-elements-textSecondary mb-2">
              API Token
            </label>
            <input
              type="password"
