        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-codelaunch-elements-background-depth-2 dark:bg-codelaunch-elements-background-depth-3 text-codelaunch-elements-textPrimary dark:text-codelaunch-elements-textPrimary-dark hover:bg-codelaunch-elements-background-depth-3 dark:hover:bg-codelaunch-elements-background-depth-4 border border-codelaunch-elements-borderColor dark:border-codelaunch-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
