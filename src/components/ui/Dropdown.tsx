...
export const DropdownItem = ({ children, onSelect, className }: DropdownItemProps) => (
  <DropdownMenu.Item
    className={classNames(
      ...
      'text-codelaunch-elements-textPrimary hover:text-codelaunch-elements-textPrimary',
...
export const DropdownSeparator = () => (
  <DropdownMenu.Separator className="h-px bg-codelaunch-elements-borderColor my-1" />
);
