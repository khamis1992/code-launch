      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-codelaunch-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-codelaunch-elements-item-backgroundAccent hover:bg-codelaunch-elements-artifacts-backgroundHover"
