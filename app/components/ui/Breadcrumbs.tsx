      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-codelaunch-elements-textPrimary dark:text-codelaunch-elements-textPrimary-dark'
              : 'text-codelaunch-elements-textSecondary dark:text-codelaunch-elements-textSecondary-dark hover:text-codelaunch-elements-textPrimary dark:hover:text-codelaunch-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-codelaunch-elements-textTertiary dark:text-codelaunch-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
