  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-codelaunch-elements-borderColor bg-codelaunch-elements-background-depth-1 text-codelaunch-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return (
      <p ref={ref} className={classNames('text-sm text-codelaunch-elements-textSecondary', className)} {...props} />
    );
  },
);
